...
import numpy as np
import pandas as pd
from src.titan.low.decision_tree import find_best_split
...
class FastDecisionTreeClassifier():
    ...
    def build_tree(self, dataset, curr_depth=0):
        ...
        if num_samples >= self.min_samples_split and curr_depth <= self.max_depth:
            best_split = find_best_split(dataset, num_features)
...
#
# classifier = FastDecisionTreeClassifier(min_samples_split=3, max_depth=5)
