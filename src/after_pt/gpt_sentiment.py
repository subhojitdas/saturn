# Copied from here - https://github.com/hkproj/rlhf-ppo/blob/main/gpt_sentiment.py
...
if __name__ == '__main__':
    ...
    print(sentiment_pipe(text,
                         **sent_kwargs))  # [{'label': 'NEGATIVE', 'score': -2.335047960281372}, {'label': 'POSITIVE', 'score': 2.557039737701416}]
    ...
    for epoch, batch in tqdm(enumerate(ppo_trainer.dataloader)):
        ...
        for query in query_tensors:
            ...
            response = ppo_trainer.generate(query,
                                            **response_generation_kwargs)  # It returns the (query + response) tokens
            response_tensors.append(response.squeeze()[
                                    -gen_len:])  # Only take the tokens corresponding to the generated response (remove the prompt/query from the beginning)
